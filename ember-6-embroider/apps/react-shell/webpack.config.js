...
module.exports = {
  ...
  plugins: [
    new webpack.DefinePlugin({
      ...
      // Production: set EMBER_APP_URL to production domain or use relative URLs
    ...
    new ModuleFederationPlugin({
      ...
      remotes: {
        ...
        // Note: emberBlog is loaded manually via dynamic import() in EmberBlogApp component
        // because Vite generates ESM format that Webpack cannot consume directly
      },
      shared: {
        react: {
          singleton: true,
